...
const HireMe = () => {
  return (
    <div className="HireMe">
      <h1 className="hire-me-header">About the Developer</h1>
      <img src={Pic} alt="Big Steve" className="profile-pic" />
      <div className="hire-me-story">
        <h2>
          Hi, my name is Steve Anderson and I'm a mortgage junkie making his way
          into tech!
        </h2>
        <p>
        ...
        <p>
          Prior to attending Grand Circus I wore many hats. I was a high school
          history teacher, football coach, I slung mortgages, taught and trained
          others how to sling mortgages, analyzed how well those mortgages were
          being sold, and managed a workforce of mortgage professionals.
        </p>
        <p>
          While wearing all of those hats I was exposed to the endless sides of
          Tech. I was fortunate enough to learn a little about a lot of things
          including but none of it was enough to start a career.
        </p>
        <p>
        ...
        <p>
          ...
          check out some of my work below or feel free to shoot me an email.
        </p>
        <nav className="hire-me-nav">
          <ul>
            <a href="mailto:swanderson79@gmail.com">Email</a>
          </ul>
          <ul>
            <a href="https://github.com/BukHwt">GitHub</a>
          </ul>
          <ul>
            <a href="https://www.linkedin.com/in/stephen-anderson-steve-anderson">
              LinkedIn
            </a>
          </ul>
        </nav>
